...
-- - Triggers pour créer automatiquement une créance lors de la création d'une facture
-- ============================================================================
...
DROP TRIGGER IF EXISTS trigger_receivable_status ON receivables;
...
DROP TRIGGER IF EXISTS trigger_payment_receivable_update ON payment_transactions;
...
DROP TRIGGER IF EXISTS trigger_invoice_receivable ON invoices;
...
-- ============================================================================
-- DÉSACTIVER RLS (car l'app utilise Clerk, pas Supabase Auth)
-- ============================================================================
