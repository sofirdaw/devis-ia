...
- Name: performance.spec.ts >> Performances Web Vitals & Vitesse de Chargement (0-100ms) >> mesure la vitesse d'accès au Manifest PWA (doit être < 150ms)
- Location: e2e\performance.spec.ts:33:7
