          ...
          <div className="flex flex-wrap items-center justify-between gap-2 mb-6">
            ...
            <div className="text-right text-sm text-gray-500">
              ...
              {typedInvoice.due_date && (
                <p>Échéance le {formatDate(typedInvoice.due_date)}</p>
              )}
            </div>
          </div>
            ...
            <div className="w-full sm:w-64 space-y-2">
              ...
              {typedInvoice.discount > 0 && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900">
                    -{formatCurrency(typedInvoice.discount)}
                  </span>
                </div>
              )}
              {typedInvoice.tax > 0 && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900">
                    {formatCurrency(typedInvoice.tax)}
                  </span>
                </div>
              )}
          ...
          {typedInvoice.receivable && (
            <div className="mt-6 pt-6 border-t border-gray-100">
              ...
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="text-gray-500">
                  Reste :{" "}
                  {formatCurrency(typedInvoice.receivable.remaining_amount)}
                </span>
              </div>
